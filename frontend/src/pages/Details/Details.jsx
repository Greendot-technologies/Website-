                    ...
                    <div className='breadcrumbWrapper mb-4'>
                        <div className='container-fluid'>
                            <ul className="breadcrumb breadcrumb2 mb-0">
                                ...
                                <li><Link to='' className='text-capitalize'>{prodCat.subCatName}</Link> </li>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-md-5'>
                            ...
                            <div  className='item'>
                                                    <InnerImageZoom
                                                        ...
                                                        src={`${zoomInage}?im=Resize=(${bigImageSize[0]},${bigImageSize[1]})`} />
                            ...
                            <Slider {...settings} className='zoomSlider' ref={zoomSlider}>
                                ...
                                {/* {
                                    ...
                                    currentProduct.productImages.map((imgUrl, index) => {
                                        return ( */}
                                            <div className='item'>
                                                <img src={`https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-0-202305292130.jpg?im=Resize=(420,420)?im=Resize=(${smlImageSize[0]},${smlImageSize[1]})`} className='w-100'
                                                    onClick={() => goto('https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-0-202305292130.jpg?im=Resize=(420,420)')} />
                                            </div>
                                            <div className='item'>
                                                <img src={`https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-1-202305292130.jpg?im=Resize=(420,420)?im=Resize=(${smlImageSize[0]},${smlImageSize[1]})`} className='w-100'
                                                    onClick={() => goto('https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-1-202305292130.jpg?im=Resize=(420,420)?im=Resize=(420,420)')} />
                                            </div>
                                            <div className='item'>
                                                <img src={`https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-2-202305292130.jpg?im=Resize=(420,420)?im=Resize=(${smlImageSize[0]},${smlImageSize[1]})`} className='w-100'
                                                    onClick={() => goto('https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-2-202305292130.jpg?im=Resize=(420,420)?im=Resize=(420,420)')} />
                                            </div>
                                            <div className='item'>
                                                <img src={`https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-3-202305292130.jpg?im=Resize=(420,420)?im=Resize=(${smlImageSize[0]},${smlImageSize[1]})`} className='w-100'
                                                    onClick={() => goto('https://www.jiomart.com/images/product/original/490000363/maggi-2-minute-masala-noodles-70-g-product-images-o490000363-p490000363-3-202305292130.jpg?im=Resize=(420,420)?im=Resize=(420,420)')} />
                                            </div>
                                        {/* )
                                    })
                                } */}
                        ...
                        <div className='col-md-7 productInfo'>
                            ...
                            <div className='priceSec d-flex align-items-center mb-3'>
                                <span className='text-g priceLarge'>Rs 13.00</span>
                                <div className='ml-3 d-flex flex-column'>
                                    <span className='text-org'>7% Off</span>
                                    <span className='text-light oldPrice'>Rs 15.00</span>
                                </div>
                            </div>

                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. At est ipsa inventore voluptatem cumque! Reprehenderit?</p>
                                        ...
                                        {/* {
                                            currentProduct.weight.map((item, index) => {
                                                return ( */}
                                                    ...
                                                    <li className='list-inline-item'><a className='tag'>60g</a></li>
                                                    <li className='list-inline-item'><a className='tag'>80g</a></li>
                                                    <li className='list-inline-item'><a className='tag'>100g</a></li>
                                                    <li className='list-inline-item'><a className='tag'>150g</a></li>
                                                {/* )
                                            })
                                        } */}
                                    </ul>
                                    ...
                                    <ul className='list list-inline mb-0 pl-4'>
                                        {
                                            currentProduct.RAM.map((RAM, index) => {
                                                return (
                                                    <li key={index} className='list-inline-item'><a className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index)}>{RAM} GB</a></li>
                                                )
                                            })
                                        }
                                    </ul>
                                    ...
                                    <ul className='list list-inline mb-0 pl-4'>
                                        {
                                            currentProduct.SIZE.map((SIZE, index) => {
                                                return (
                                                    <li key={index} className='list-inline-item'><a className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index)}>{SIZE}</a></li>
                                                )
                                            })
                                        }
                                    </ul>
